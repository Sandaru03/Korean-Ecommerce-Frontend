    ...
    <footer>
      ...
      <div className="bg-coupang-blue py-4">
        <div className="mx-auto flex max-w-[1280px] items-center justify-center gap-4 px-4">
          <Truck className="h-8 w-8 text-[#fff]" />
          <div className="text-center">
            <p className="text-lg font-bold text-[#fff]">Free Delivery on First Order!</p>
            <p className="text-sm text-[#fff]/80">Sign up now and get free shipping on your first purchase</p>
          </div>
          <button className="rounded-full bg-[#fff] px-6 py-2 text-sm font-semibold text-coupang-blue hover:bg-[#f0f0f0] transition-colors">
            Sign Up
          </button>
        </div>
      </div>
      ...
      {/* Main Footer */}
      <div className="bg-[#fff] border-t border-[#e5e5e5]">
          ...
          <div className="grid grid-cols-2 gap-8 md:grid-cols-4 lg:grid-cols-5">
            ...
            <div className="col-span-2 md:col-span-1">
              <div className="flex items-center gap-1 mb-4">
                ...
                <span className="text-xl font-bold text-coupang-blue">coupang</span>
              </div>
              <p className="text-xs text-[#888] leading-relaxed">
                Wow, no life without Coupang!
                Korea&apos;s leading e-commerce platform delivering happiness through rocket speed.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="flex flex-col gap-2">
                ...
                <li><a href="#" className="text-xs text-[#666] hover:text-coupang-blue transition-colors">Coupang Play</a></li>
              </ul>
            </div>

            {/* Sell on Coupang */}
            <div>
              <h3 className="mb-3 text-sm font-bold text-[#333]">Sell on Coupang</h3>
              <ul className="flex flex-col gap-2">
        ...
        <div className="border-t border-[#f0f0f0]">
          <div className="mx-auto flex max-w-[1280px] items-center justify-between px-4 py-4">
            <p className="text-[11px] text-[#aaa]">
              {"Coupang Corp. | CEO: Bom Kim | Business Reg. No: 120-88-00767"}
            </p>
            <p className="text-[11px] text-[#aaa]">
              {"Copyright 2026 Coupang Corp. All rights reserved."}
            </p>
          </div>
        </div>
      </div>
