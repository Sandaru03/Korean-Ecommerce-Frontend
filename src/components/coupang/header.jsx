    ...
    <header className="sticky top-0 z-50 bg-white shadow-sm">
      ...
      <div className="mx-auto flex max-w-[1280px] items-center gap-4 px-4 py-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <button className="relative flex flex-col items-center gap-0.5 px-2 py-1 text-[#333] hover:text-coupang-blue transition-colors">
            ...
            <span className="absolute -top-0.5 right-0 flex h-4 w-4 items-center justify-center rounded-full bg-coupang-red text-[10px] font-bold text-white">
              3
            </span>
          </button>
        </div>
      ...
      <nav className="border-t border-[#e5e5e5] bg-white">
        <div className="mx-auto flex max-w-[1280px] items-center gap-0 overflow-x-auto px-4">
          <button
            className="flex shrink-0 items-center gap-1 border-r border-[#e5e5e5] px-4 py-2.5 text-sm font-medium text-[#333] hover:text-coupang-blue transition-colors"
            onClick={() => setShowCategories(!showCategories)}
          >
          ...
          {categories.map((cat) => (
            <a
              key={cat}
              href="#"
              className="shrink-0 px-3 py-2.5 text-[13px] text-[#555] hover:text-coupang-blue transition-colors"
            >
              {cat}
            </a>
          ))}
      ...
      {showCategories && (
        <div className="absolute left-0 top-full z-50 w-full border-t border-[#e5e5e5] bg-white shadow-lg lg:w-64">
