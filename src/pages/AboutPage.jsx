...
import { Sprout, Star, MapPin, CheckCircle, Users, Truck, Sparkles, Heart } from 'lucide-react';
...
const content = {
  en: {
    ...
    commitmentBody:
      "Many companies manufacture products specifically for export to foreign markets. These are often produced at a lower cost for wholesale distribution and may not be subject to the same stringent health and safety regulations required for products sold within South Korea. At Samee and Sandu K-Beauty Secret, we guarantee that every product you purchase is:",
    pillars: [
      {
    ...
    whyItems: [
      {
        icon: <CheckCircle className="w-7 h-7 text-[#E4405F]" />,
  ...
  si: {
    langLabel: "සිං",
    badge: "100% කොරියානු දේශීය ශ්‍රේණිය",
    heroLine1: "සැබෑ කොරියානු",
    heroLine2: "රූපලාවන්‍ය රහස",
    heroLine3: "දැන්",
    heroLine4: "ඔබේ දෑතට!",
    heroIntro:
      "ආයුබෝවන්! 👋 අපි Samee සහ Sandu. වසර කිහිපයක සිට දකුණු කොරියාවේ පදිංචිව සිටින අපට, කොරියානු වැසියන්ගේ නිරෝගී සහ දීප්තිමත් සමේ රහස සමීපව අත්දැකීමට අවස්ථාව ලැබුණා. ඒ සැබෑ අත්දැකීම සහ කොරියාවේ උසස්ම නිෂ්පාදන අපේ ලංකාවේ ආදරණීයයන්ට ලබාදීමේ අරමුණින් ආරම්භ කළා",
    heroIntroHighlight: ' "Samee and Sandu K-Beauty Secret."',
    commitmentTitle: "අපේ සුවිශේෂී වගකීම",
    commitmentSubtitle: "කොරියානු දේශීය ප්‍රමිතිය",
    commitmentBody:
      "වෙළඳපොළේ ඇති බොහෝ කොරියානු නිෂ්පාදනවලට වඩා අපේ නිෂ්පාදන වෙනස් වන්නේ ඇයි? මෙන්න ඒ රහස: බොහෝ සමාගම් විදේශ වෙළඳපොළ ඉලක්ක කර අඩු පිරිවැයකින් නිෂ්පාදන සිදු කරයි. ඒවා තොග වශයෙන් ලබා දීමට නිපදවන නිසා, බොහෝ විට ඒවා කොරියානු රජයේ දැඩි සෞඛ්‍ය ප්‍රමිතීන්ට යටත් නොවිය හැකිය. නමුත් Samee and Sandu K-Beauty Secret වෙතින් ඔබ ලබාගන්නා සෑම නිෂ්පාදනයක්ම:",
    pillars: [
      {
        icon: <Sprout className="w-8 h-8 text-white" />,
        title: "කොරියානු ජාතිකයන් සඳහාම නිපදවූ",
        body: "දකුණු කොරියාවේ වෙසෙන ජනතාවගේ පරිභෝජනය සඳහා එරට සෞඛ්‍ය අමාත්‍යාංශයේ සහ නීතිමය ආයතනවල (KFDA) දැඩි අධීක්ෂණය යටතේ නිපදවන ලද ඉහළම ගුණාත්මක නිෂ්පාදන වේ.",
      },
      {
        icon: <Star className="w-8 h-8 text-white" />,
        title: "පිරිවැයට වඩා ගුණාත්මක බව",
        body: "අඩු පිරිවැයකින් තොග වශයෙන් නිපදවන නිෂ්පාදනවලට වඩා, දේශීය ප්‍රමිතියට (Domestic Standard) අනුව නිපදවන භාණ්ඩවල අමුද්‍රව්‍යවල ගුණාත්මකභාවය ඉතා ඉහළය.",
      },
      {
        icon: <MapPin className="w-8 h-8 text-white" />,
        title: "අපේ සහතිකය",
        body: "අපි කොරියාවේ ජීවත් වන නිසා, මෙහි හොඳම රෝහල් සහ විශේෂඥයන් නිර්දේශ කරන නිෂ්පාදන සෘජුවම මිලදී ගෙන ඔබට ලබා දීමට අපට හැකියාව ඇත.",
      },
    ],
    ...
    whyItems: [
      {
        icon: <CheckCircle className="w-7 h-7 text-[#E4405F]" />,
        title: "100% Authentic",
        body: "අප සතු සියලුම නිෂ්පාදන කොරියාවේ නිල අලෙවිසැල්වලින් සෘජුවම ලබාගන්නා බවට වගකීම සහතික කරමු.",
      },
      {
        icon: <Users className="w-7 h-7 text-[#E4405F]" />,
        title: "Expert Curation",
        body: "අපේ පවුලේ අය, විශේෂයෙන්ම සඳූ සහ අපේ දූ පැංචි පෞද්ගලිකව භාවිතා කර ගුණාත්මක බව අත්විඳි නිෂ්පාදන පමණක් අපි ඔබට හඳුන්වා දෙන්නෙමු.",
      },
      {
        icon: <Truck className="w-7 h-7 text-[#E4405F]" />,
        title: "Direct Delivery",
        body: "අතරමැදියන් නොමැතිව කොරියාවේ සිට සෘජුවම ඔබ අතට පත් කරන නිසා විශ්වාසනීයත්වය උපරිමය.",
      },
    ],
    visionTitle: "අපේ දැක්ම",
    visionBody:
      "අපේ එකම බලාපොරොත්තුව, අඩු පිරිවැයකින් නිපදවන සාමාන්ය නිෂ්පාදන වෙනුවට, කොරියානු වැසියන් සැබෑ ලෙසම පාවිච්චි කරන ඒ උසස්ම රූපලාවන්ය රහස් ලංකාවට ලබා දී, ඔබවත් වඩාත් දීප්තිමත් සහ සෞඛ්ය සම්පන්න පුද්ගලයෙකු බවට පත් කිරීමයි.",
    visionCta: "සැබෑ කොරියානු ප්‍රමිතිය අත්විඳීමට අදම අප හා එක්වන්න!",
    meetTitle: "අපි ගැන (About Us) 👋",
    meetBody: "සැබෑ අත්දැකීම. සැබෑ කොරියානු රූපලාවන්‍ය — ආදරයෙන් ඔබ අතට.",
    founderNames: "Samee සහ Sandu",
    founderRole: "නිර්මාතෘවරුන් · K-Beauty විශේෂඥයන් · දකුණු කොරියාවේ පදිංචි",
    founderQuote: '"කොරියාවේ ජීවිතය අප වෙනස් කළා — ඒ රහස ඔබ සමඟ බෙදාගැනීමට ආශාව ඇත."',
    familyTitle: "අපේ පවුල",
    familyLocation: "ශ්‍රී ලංකාව · දකුණු කොරියාව",
  ...
  ta: {
    ...
    heroLine1: "உண்மையான",
    heroLine2: "කොරියානු රූපලාවන්‍ය",
    heroLine3: "රහස",
    heroLine4: "දැන් ඔබේ දෑතට!",
    heroIntro:
      "வணக்கம்! 👋 நாம் සමි සහ සන්දු. கடந்த சில வருடங்களாகத் தென்கොரியாவில் වසමින් සිටි එமக்கு, කොරියානු மக்களின் රහස හඳුනාගැනීමට අවස්ථාව ලැබුණා. ආරම්භ කළා",
    heroIntroHighlight: ' "Samee and Sandu K-Beauty Secret."',
    commitmentTitle: "எமது ප්‍රත්‍යෙක උරුමය",
    commitmentSubtitle: "කොරියානු දේශීය ප්‍රමිතිය",
    commitmentBody:
      "බොහෝ සමාගම් විදේශ වෙළඳපොළ ඉලක්ක කර අඩු පිරිවැයකින් නිෂ්පාදන සිදු කරයි. මේ නිසා Samee and Sandu K-Beauty Secret මගින් ඔබ ලබාගන්නා නිෂ්පාදන සුවිශේෂී වේ.",
    pillars: [
      {
        icon: <Sprout className="w-8 h-8 text-white" />,
        title: "කොරියානු ජාතිකයන් සඳහාම",
        body: "KFDA දැඩි අධීක්ෂණය යටතේ නිෂ්පාදනය කරන ලද උසස් නිෂ්පාදන.",
      },
      {
        icon: <Star className="w-8 h-8 text-white" />,
        title: "ගුණාත්මක බව",
        body: "අපනයනය සඳහා නිපදවන භාණ්ඩවලට වඩා ඉහළ ප්‍රමිතියකින් යුක්තය.",
      },
      {
        icon: <MapPin className="w-8 h-8 text-white" />,
        title: "සෘජු සැපයුම",
        body: "කොරියාවේ විශේෂඥයන් නිර්දේශ කරන නිෂ්පාදන සෘජුවම ලබා දෙන්නෙමු.",
      },
    ],
    whyTitle: "අපි සුවිශේෂී වන්නේ ඇයි?",
    whyItems: [
      {
        icon: <CheckCircle className="w-7 h-7 text-[#E4405F]" />,
        title: "100% විශ්වසනීයයි",
        body: "සියලුම නිෂ්පාදන කොරියාවේ නිල අලෙවිසැල්වලින් සෘජුවම ලබාගන්නා බවට සහතික වෙමු.",
      },
      {
        icon: <Users className="w-7 h-7 text-[#E4405F]" />,
        title: "විශේෂඥ තේරීම",
        body: "අපේ පවුලේ අය පෞද්ගලිකව භාවිතා කර අත්විඳි නිෂ්පාදන පමණි.",
      },
      {
        icon: <Truck className="w-7 h-7 text-[#E4405F]" />,
        title: "සෘජු බෙදාහැරීම",
        body: "අතරමැදියන් නොමැතිව කොරියාවේ සිට සෘජුවම ඔබ අතට.",
      },
    ],
    visionTitle: "අපේ දැක්ම",
    visionBody:
      "කොරියානු වැසියන් සැබෑ ලෙසම පාවිච්චි කරන ඒ උසස්ම රූපලාවන්‍ය රහස් ලංකාවට ලබා දීම අපේ අරමුණයි.",
    visionCta: "අදම අප හා එක්වන්න!",
    meetTitle: "අපව හමුවන්න 👋",
    meetBody: "සැබෑ අත්දැකීම්. සැබෑ කොරියානු රූපලාවන්‍ය — ආදරයෙන් ඔබ අතට.",
    founderNames: "සමි සහ සන්දු",
    founderRole: "නිර්මාතෘවරුන් · K-Beauty විශේෂඥයන්",
    founderQuote: '"ඒ රහස ඔබ සමඟ බෙදාගැනීමට ආශාව ඇත."',
    familyTitle: "අපේ පවුල",
    familyLocation: "ශ්‍රී ලංකාව · දකුණු කොරියාව",
    familyQuote: '"ගුණාත්මකභාවය ගැන අපි නිශ්චිතයි."',
    shopNow: "දැන් සොයා ගන්න",
  },
};
